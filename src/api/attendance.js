...
export const getRequestHistory = () => api.get('/attendance/request-history')
export const getRequestHistoryCounts = () => api.get('/attendance/request-history/counts')
export const getVacationHistory = () => api.get('/attendance/vacation-history')
